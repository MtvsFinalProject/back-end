...
public class QLockerGuestBook extends EntityPathBase<GuestBook> {
    ...
    public QLockerGuestBook(Path<? extends GuestBook> path) {
    ...
    public QLockerGuestBook(Class<? extends GuestBook> type, PathMetadata metadata, PathInits inits) {
